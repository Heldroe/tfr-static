...
func TestHTMLGenerator_GenerateAll(t *testing.T) {
	...
	assertFileContains(t, modIndex, `source  = "registry.example.com/modules/server/hetzner"`)
	...
	assertFileContains(t, verIndex, `source  = "registry.example.com/modules/server/hetzner"`)
